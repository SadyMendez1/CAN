            ...
            while ($fila = mysqli_fetch_array($query)){
                ...
                <tr>
                    ...
                    <th scope="row">
                        ...
                        <a href="CRUD/EliminarDato.php?ID=<?php echo $fila['idprod']?>" onclick="return  confirm ('¿Está seguro de eliminar estos datos?'); false" class="btn btn-danger">Eliminar Datos</a>
                    </th>
                </tr>
                <?php
            }
