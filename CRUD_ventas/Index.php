...
<body style=" 
  ...
  background-color: #68bb7e;" >
    ...
    <!--Header-->
    <header>
    <a href="Index.php" class="logo">CAN</a>
    </header>
    <!--Fin Header-->

    <!--CRUD-->
<div class="container bg-dark p-3 border border-dark rounded position-absolute">
    <h1 class="bg-secondary p-2 text-white text-center rounded">SISTEMA CAN - CRUD VENTAS</h1>


    <br>
    <div class="container">
        <a href="Forms/AgregarEmpleado.php" class="btn bg-light border border-dark">Agregar/Consultar Venta</a>
    </div>
    <br>
