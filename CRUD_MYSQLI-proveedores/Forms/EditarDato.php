...
<div class="container bg-dark p-3 border border-dark rounded position-absolute">
    ...
    <h1 class="bg-secondary p-2 text-white text-center rounded">SISTEMA CAN - Editar proveedor</h1>
    <br>
    ...
    <div class="container">
        ...
        <!-- $fila['*'] se conecta con una columna de la db cliente  -->
            ...
            <input type="Hidden" name="ID" value="<?php echo $fila['idprov']?>">
            
            <div class="mb-3">
                <label class="form-label text-white">Nombre del Proveedor</label>
                <input type="text" class="form-control" placeholder="Nombre del proveedor" name="NombreProv" value="<?php echo $fila['nombre_prov']?>">
            </div>
            ...
            <div class="container text-center">
                <button type="submit" class="btn bg-light border border-dark">Editar Proveedor</button>
