...
<div class="container bg-dark p-3 border border-dark rounded position-absolute">
    <h1 class="bg-secondary p-2 text-white text-center rounded">SISTEMA CAN - CRUD Empleados</h1>


    <br>
    <div class="container">
        <a href="Forms/AgregarEmpleado.php" class="btn bg-light border border-dark">Agregar empleado</a>
    </div>
    <br>
