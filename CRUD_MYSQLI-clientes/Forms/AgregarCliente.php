...
<div class="container bg-dark p-3 border border-dark rounded position-absolute">
    <h1 class="bg-secondary p-2 text-white text-center rounded">SISTEMA CAN - Agregar cliente</h1>
...
<!--el placeholder="*" es solo lo que se ve dentro del textbox; el name="*" se conectará con insertarphp en $_POST['*']-->       
            ...
            <div class="mb-3">
                <input type="text" class="form-control" placeholder="Nombre del cliente" name="NombreCliente">
            </div>
            <div class="mb-3">
                <input type="text" class="form-control" placeholder="Apellido del cliente" name="ApellidoCliente">
            </div>
            <div class="mb-3">
