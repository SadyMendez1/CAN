...
<div class="container bg-dark p-3 border border-dark rounded position-absolute">
    ...
    <h1 class="bg-secondary p-2 text-white text-center rounded">SISTEMA CAN - CRUD Categorías</h1>
    <br>
    <div class="container">
            ...
            while ($fila = mysqli_fetch_array($query)){
                ...
                <tr>
                    ...
                    <th scope="row">
                        ...
                        <a href="CRUD/EliminarDato.php?ID=<?php echo $fila['id']?>" onclick="return  confirm ('¿Está seguro de eliminar estos datos?'); false" class="btn btn-danger">Eliminar Datos</a>
                    </th>
                </tr>
                <?php
            }
